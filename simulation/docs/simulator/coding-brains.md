...
- When the directness of the code starts to feel limiting — when you want to edit connection weights live, or add a filtering layer between sensor and motor — continue to [Wiring Brains](wiring-brains.md).
